import 'package:delivery_backoffice_admin/src/modules/payment_type/widgets/payment_type_form/payment_type_form_modal.dart';
      ...
      final statusDisposer = reaction((_) => controller.status, (status) {
        switch (status) {
          ...
          case PaymentTypeStatus.loading:
            showLoader();
            break;
          case PaymentTypeStatus.loadead:
            hideLoader();
            break;
